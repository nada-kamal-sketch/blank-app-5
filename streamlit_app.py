...
BloodPressure=st.number_input('feature_4',min_value=0,max_value=122)
SkinThickness=st.number_input('feature_5',min_value=0,max_value=99)
Insulin=st.number_input('feature_6',min_value=0,max_value=846)
BMI=st.number_input('feature_7',min_value=0.0,max_value=67.1,value=1.0)
